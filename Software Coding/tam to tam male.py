...
def on_press(key):
    try:
        if key.char == "s":
            picam2.capture_file("tatota.jpg")
...
img = cv2.imread('/home/sk2/Documents/Vision ocr/tatota.jpg')
...
# Get the detected text and translate it to a different language
    ...
    voice = texttospeech.VoiceSelectionParams(language_code="ta-IN", name="ta-IN-Standard-D")
    ...
    with open("tatota translated_text.mp3", "wb") as f:
        f.write(response.audio_content)
        print(f"Audio content written to file 'tatota translated_text.mp3'.")
song = AudioSegment.from_mp3("tatota translated_text.mp3")
print('playing')
play(song)
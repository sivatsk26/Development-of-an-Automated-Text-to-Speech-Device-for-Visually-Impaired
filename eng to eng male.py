...
def on_press(key):
    try:
        if key.char == "s":
            picam2.capture_file("entoen.jpg")
...
img = cv2.imread('/home/sk2/Documents/Vision ocr/entoen.jpg')
...
# Get the detected text and translate it to a different language
    ...
    with open("entoen translated_text.mp3", "wb") as f:
        f.write(response.audio_content)
        print(f"Audio content written to file 'entoen translated_text.mp3'.")
song = AudioSegment.from_mp3("entoen translated_text.mp3")
print('playing')
play(song)